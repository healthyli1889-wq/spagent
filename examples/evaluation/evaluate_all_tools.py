"""
Evaluation script combining Pi3X, GroundingDINO + SAM2, and Veo tools.
...
def build_tool_configs() -> Dict[str, List[Any]]:
    """Lazily build tool configurations (avoids connecting on import)."""
    return {
        # --- vision / perception ---
        "dinosam": [
        ...
        # --- video generation ---
        "veo_real": [VeoTool(use_mock=False)],
        "veo_mock": [VeoTool(use_mock=True)],
    }
...
ALL_CONFIGS = VISION_CONFIGS | VIDEO_GEN_CONFIGS
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  Groups:  all_vision | all_video | all\n"
